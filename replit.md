...
-   **Magic Import**: An onboarding funnel that scrapes public Telegram channels, uses OpenAI GPT-4o-mini Vision to extract product data, and automatically creates a tenant, user, and up to 20 products with a trial period.
